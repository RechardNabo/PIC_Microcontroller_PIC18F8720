...
int PWM_MAX_DUTY(){
   return(0x12BFCE0/(Frequency*16));
}

void PWM1_INITIALIZE(long frequency){
  PR2 = (0x12BFCE0/(Frequency*4*16)) - 1;
  Frequency = frequency;
}
...
void main(void) {
    ...
    while(0x01){
        ...
        LCD_20_LINE1();
        LCD_DISPLAY("***PIC18F8720-PWM***");
        LCD_20_LINE2();
        LCD_DISPLAY("PWM-RG0-CPP3: ");
        LCD_DISPLAY_DIGIT((float)ADC_Read(0));
        PWM3_Duty((float)ADC_Read(0));
